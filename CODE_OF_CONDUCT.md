# Code of Conduct — Azerbaijan GitHub Community

## 1. Purpose

Azerbaijan GitHub Community is dedicated to building an open, welcoming, and safe environment for everyone who contributes, learns, mentors, or participates in our projects and events. This Code of Conduct describes our expectations for participant behavior and outlines steps for reporting and addressing unacceptable behavior.
...
In the interest of fostering an open and welcoming environment, we as contributors and maintainers pledge to make participation in our community a harassment-free experience for everyone, regardless of background, identity, or experience level.
...
As a FOSS-focused community, we also expect:

**Constructive code review**
Focus on code and design rather than the contributor. Explain improvements clearly and respectfully.

**Attribution and credit**
Acknowledge contributors and sources. Do not remove or obscure license notices or authorship.

**License respect**
Ensure contributions comply with the project’s license. Do not submit code or content that you do not have the right to license.

**No gatekeeping**
Encourage participation and knowledge sharing across all skill levels.

**AI-generated content responsibility**
If using AI-generated code or content, clearly disclose it and verify correctness, quality, and licensing compatibility.
...
When a report is received, moderators or organizers will generally follow these steps:

1. **Acknowledge receipt** of the report.
2. **Collect information**, including reviewing logs and evidence.
3. **Assess severity** of the behavior.
4. **Apply interim measures** if necessary (mute, temporary removal, etc.).
5. **Determine resolution**, which may include warning, suspension, temporary ban, or permanent ban.
6. **Appeal process** may be available and reviewed by a separate group of organizers.

Decisions will aim to be fair, transparent, and respectful of privacy.
...
Anyone representing the community publicly (organizers, moderators, speakers) must adhere to this Code of Conduct and clearly distinguish personal opinions from official community positions.

## 15. Legal & Safety Notes

This Code of Conduct is not a substitute for legal advice. For criminal threats or illegal activities, appropriate authorities may be contacted. Relevant evidence may be preserved if necessary.

## 16. Attribution

This document is inspired by widely adopted open source community practices and templates and may evolve as the Azerbaijan GitHub Community grows.
